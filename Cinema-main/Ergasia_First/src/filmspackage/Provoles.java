...
public class Provoles implements Serializable {
	...
	public Provoles(String provoliID, String provoliFilm, String provoliCinema, String provoliStartDate, String provoliEndDate, int provoliNumberOfReservations, boolean provoliIsAvailable) {
